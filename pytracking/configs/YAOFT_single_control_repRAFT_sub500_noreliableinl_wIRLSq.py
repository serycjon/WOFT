...
from pytracking.utils.least_squares_H import find_homography_IRLSq_QR, IRLSq_Huber, torch_proj_errors
...
def find_homography(pts_A, pts_B, weights=None):
    ...
    def reweight(residuals):
        return IRLSq_Huber(residuals, k=2)
    res = find_homography_IRLSq_QR(pts_A, pts_B, weights=weights, reweighting_fn=reweight)
    return res
